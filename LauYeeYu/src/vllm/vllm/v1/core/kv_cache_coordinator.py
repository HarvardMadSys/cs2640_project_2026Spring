...
class UnitaryKVCacheCoordinator(KVCacheCoordinator):
    ...
    def match_prefix_cache(
        ...
        segments = self.single_type_managers[0].match_prefix_cache(
            block_hashes=block_hashes,
            max_length=max_cache_hit_length,
            kv_cache_group_ids=[0],
            block_pool=self.block_pool,
...
class HybridKVCacheCoordinator(KVCacheCoordinator):
    ...
    def match_prefix_cache(
        ...
        """
        Find all cache hits for different KV cache groups, and return in the format
        of a list of KVCacheBlockSegment for each hit block segment.
        ...
        Returns:
            A list of KVCacheBlockSegment for each hit block segment.
        """
