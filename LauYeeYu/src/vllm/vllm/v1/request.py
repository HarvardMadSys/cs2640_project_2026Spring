...
if TYPE_CHECKING:
    ...
    from vllm.v1.core.kv_cache_utils import (BlockHash, KVCacheBlocks,
                                             KVCacheBlockSegment)
...
class Request:
    def __init__(
        ...
        # Cached block segments for filling gaps in prefix caching.
        self.computed_segments: list["KVCacheBlockSegment"] = []
