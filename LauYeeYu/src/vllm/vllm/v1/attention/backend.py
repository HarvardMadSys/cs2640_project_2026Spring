...
class CommonAttentionMetadata:
    ...
    # Maps request batch index -> list of (gap_start, gap_len) tuples.
    # When present, the request's tokens fill multiple non-contiguous gaps
    # in a single forward step.
    hole_fill_gap_ranges: dict[int, list[tuple[int, int]]] | None = None
