...
class SchedulerOutput:
    ...
    # req_id -> list of (gap_start_token, gap_length_tokens) pairs.
    # When present, the request's scheduled tokens fill multiple non-contiguous
    # gaps in a single forward step, using cascade attention for efficiency.
